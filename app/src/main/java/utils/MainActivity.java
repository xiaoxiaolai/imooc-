...
//	private float alpha;
//	private File blurredImage=null;
//
//	@Override
...
//         blurredImage = new File(Environment.getExternalStorageDirectory().getPath()  + BLURRED_IMG_PATH);
...
//					mBlurredImage.setAlpha((float)1);
//				}
//
...
////		Log.d("---",blurredImage.getPath());
////		Bitmap bmpBlurred = BitmapFactory.decodeFile(blurredImage.getPath());
//		Bitmap bmpBlurred = BitmapFactory.decodeResource(getResources(), R.drawable.image);
//		Bitmap newImg = Blur.fastblur(MainActivity.this, bmpBlurred, 12);
//		newImg = Bitmap.createScaledBitmap(newImg, screenWidth, (int) (newImg.getHeight()
//				* ((float) screenWidth) / (float) newImg.getWidth()), false);
//
//		mBlurredImage.setImageBitmap(newImg);
//
//		mBlurredImageHeader.setoriginalImage(newImg);
//	}
//}
