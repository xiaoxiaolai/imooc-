...
public class VitamioChapterInfoAdapter extends BaseExpandableListAdapter {
    ...
    public VitamioChapterInfoAdapter(List<ChapterInfo.DataBean> armTypes, List<DownLoadChapterInfo> chapterInfos, Context context) {
    ...
    public VitamioChapterInfoAdapter(Context context) {
        this.context = context;
        inflater = LayoutInflater.from(context);
    }
...
//        return textView;
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.vitamio_list_item_group_child, null);
...
//            }
//        }
        if(groupPosition==x&&childPosition==y){
            childHolder.textView.setTextColor(Color.parseColor("#7ff01400"));
        }else {
            childHolder.textView.setTextColor(Color.parseColor("#ff212121"));
        }
        Log.d(TAG, "getChildView: "+groupPosition+childPosition+"----------------------------");
        return convertView;
    }
public void uodata(int i,int i1){
    this.x=i;
    this.y=i1;
//    notifyDataSetChanged();
    Log.d(TAG, "uodata: "+i+i1+"---------------------------------");
}
    @Override
