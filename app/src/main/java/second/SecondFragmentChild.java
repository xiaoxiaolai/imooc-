...
public class SecondFragmentChild extends Fragment implements View.OnClickListener{
...
//            mCurrentPageIndex = savedInstanceState.getInt(CurrentPageIndex);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_main_second_child, container, false);
        initTabLine(view);
        initView(view);
...
//        LayoutParams lp = mTabline.getLayoutParams();
    ...
    private void initView(View view) {
        mViewPager = (ViewPager) view.findViewById(R.id.id_viewpager_child1);
