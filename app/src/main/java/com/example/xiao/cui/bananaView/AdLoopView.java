package com.example.xiao.cui.bananaView;
...
import com.example.xiao.cui.bananaView.internal.BaseLoopView;
...
public class AdLoopView extends BaseLoopView {
    ...
    private View createDefaultView() {
        ...
        int viewPagerHeight = RelativeLayout.LayoutParams.WRAP_CONTENT;
